...
export const metadata = generateSEO({
    ...
    description: "Privacy Policy for SHAREVAULT. Learn how we collect, use, and protect your personal information.",
    keywords: ["privacy policy", "data protection", "user privacy", "sharevault privacy"],
    url: "/privacy",
})
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-card brutalist-border brutalist-shadow p-8 md:p-12 prose prose-lg max-w-none prose-headings:font-black prose-headings:uppercase prose-p:font-medium">
                        ...
                        <h3>Log Files</h3>
                        <p>
                            SHAREVAULT follows a standard procedure of using log files. These files log visitors when they visit
                        ...
                        <p>
                            Like any other website, SHAREVAULT uses 'cookies'. These cookies are used to store information including
                        ...
                        <p>
                            You may consult this list to find the Privacy Policy for each of the advertising partners of SHAREVAULT.
                        </p>

                        <p>
                            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                            used in their respective advertisements and links that appear on SHAREVAULT, which are sent directly to
                        ...
                        <p>
                            Note that SHAREVAULT has no access to or control over these cookies that are used by third-party
                            advertisers.
                        </p>

                        <h3>Third Party Privacy Policies</h3>
                        <p>
                            SHAREVAULT's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                        ...
                        <p>
                            SHAREVAULT does not knowingly collect any Personal Identifiable Information from children under the age of
                        ...
                        <p>
                            ...
                            regards to the information that they shared and/or collect in SHAREVAULT. This policy is not applicable to
